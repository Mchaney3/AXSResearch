  ...
  Serial.print("ledSettingModifier: ");  Serial.print(ledSettingModifier);  Serial.print("\nledModifierValue: "); Serial.println(ledModifierValue);
    switch (ledSettingModifier) {
      case 1:  
        ...
        break;
      case 2:
        ledModifierValue = map(ledModifierValue, 0, 55, 0, 255); //  TODO: Create mapping of 10 brightness values in app
...
a2dp_sink.set_on_connection_state_changed(connection_state_changed);
  ...
  Serial.print("Bluetooth Started with name "); Serial.println(btDeviceName);
  }
  for(;;){
    btCommandIncoming();
    delay(10);
